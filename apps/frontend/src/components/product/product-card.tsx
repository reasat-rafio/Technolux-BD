  ...
  return (
    <div
      className={clsx(
        ...
        variant === 'gridSlim' && 'pe-0 md:pb-1 flex-col items-start bg-white',
        variant === 'listSmall' &&
    ...
    >
      <div
        className={clsx(
          ...
          variant === 'gridSlim' && 'mb-3 md:mb-3.5 pb-0',
          variant === 'grid' && 'mb-3 md:mb-3.5',
          imageContentClassName
        )}
      >
        <Image
          ...
          className={clsx(
            'bg-gray-300 object-cover rounded-s-md',
            variant === 'grid' &&
      ...
      <div
        className={clsx(
          ...
          variant === 'grid' && 'ps-0 lg:ps-2.5 xl:ps-4 pe-2.5 xl:pe-4',
          variant === 'gridSlim' && 'ps-0',
          variant === 'listSmall' && 'px-4 lg:px-5 2xl:px-4',
          contactClassName
        )}
      >
        <h2
