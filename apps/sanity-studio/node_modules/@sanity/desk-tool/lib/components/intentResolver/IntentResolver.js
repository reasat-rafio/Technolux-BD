...
var IntentResolver = /*#__PURE__*/_react.default.memo(function IntentResolver(_ref) {
  ...
  var _useDocumentType = (0, _helpers.useDocumentType)(documentId, specifiedSchemaType),
  ...
  var panes = (0, _react.useMemo)(() => {
    ...
    var newDocumentId = documentId === FALLBACK_ID ? (0, _uuid.uuid)() : (0, _helpers.removeDraftPrefix)(documentId);
