...
function FormView(props) {
  ...
  var patchChannel = (0, _react.useMemo)(() => _formBuilder.FormBuilder.createPatchChannel(), [documentId]);
  ...
  (0, _react.useEffect)(() => {
    var sub = _document.default.pair.documentEvents(documentId, documentType).pipe((0, _operators.tap)(event => patchChannel.receiveEvent(event))).subscribe();
  ...
  }, [compareValue, documentSchema, filterField, focusPath, handleBlur, handleChange, handleFocus, hasTypeMismatch, margins, markers, patchChannel, presence, readOnly, value]);
