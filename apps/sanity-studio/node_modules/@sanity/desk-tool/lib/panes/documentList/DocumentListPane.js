...
var _useShallowUnique = require("../../lib/useShallowUnique");
...
var DocumentListPane = /*#__PURE__*/(0, _react.memo)(function DocumentListPane(props) {
  ...
  var _pane$defaultLayout = pane.defaultLayout,
      ...
      _pane$displayOptions = pane.displayOptions,
      displayOptions = _pane$displayOptions === void 0 ? {} : _pane$displayOptions,
      initialValueTemplates = pane.initialValueTemplates,
      menuItems = pane.menuItems,
      menuItemGroups = pane.menuItemGroups,
      options = pane.options,
      schemaTypeName = pane.schemaTypeName,
      title = pane.title;
  var defaultOrdering = options.defaultOrdering,
  ...
  var showIcons = displayOptions.showIcons !== false;
