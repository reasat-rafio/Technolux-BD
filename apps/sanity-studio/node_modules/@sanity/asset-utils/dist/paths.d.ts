import type { FileUrlBuilderOptions, ImageUrlBuilderOptions, SanityAssetSource, SanityFileUrlParts, SanityImageUrlParts, SanityProjectDetails } from './types';
/**
 ...
 * @return string
 */
export declare function buildImagePath(asset: ImageUrlBuilderOptions | SanityImageUrlParts, project?: SanityProjectDetails): string;
/**
 ...
 * @return string
 */
export declare function buildImageUrl(asset: ImageUrlBuilderOptions | SanityImageUrlParts, project?: SanityProjectDetails): string;
/**
 ...
 * @return string
 */
export declare function buildFilePath(asset: FileUrlBuilderOptions | SanityFileUrlParts, project?: SanityProjectDetails): string;
/**
